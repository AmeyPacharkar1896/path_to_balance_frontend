    ...
    return IntroductionScreen(
      pages: [
        buildOnboardingPageViewModel(
          title: "Welcome",
          body: "Discover the amazing features of our app. Get started quickly and effortlessly!",
          icon: Icons.mobile_friendly,
          gradientColors: [Colors.blueAccent, Colors.lightBlueAccent],
          titleStyle: const TextStyle(
              fontSize: 32.0, fontWeight: FontWeight.bold, color: Colors.blueAccent),
        ...
        buildOnboardingPageViewModel(
          ...
          titleStyle: const TextStyle(
              fontSize: 32.0, fontWeight: FontWeight.bold, color: Colors.green),
          bodyStyle: const TextStyle(fontSize: 18.0, color: Colors.black87),
        ),
        buildOnboardingPageViewModel(
          title: "Get Started",
